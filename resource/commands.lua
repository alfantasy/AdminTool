...
cmd_helper_others = {
	...
	['chgn'] = {
		reason = ' [Nick/ID банды/ID человека] [Новое название банды] - Изменить название банды',
		tip = '		Ввести можно как ник игрока, так и ID, либо же ID банды.',
	},
	['ib'] = {
		reason = ' [Nick] - Разбанить игрока',
	},
	['ubi'] = {
